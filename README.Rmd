...
Rafael de Andrade Moral [aut], John Hinde [aut], Silvio Sandoval Zocchi
[aut,ctb], Clarice Garcia Borges Demétrio [aut,ctb].
...
## Installed the development version from Github: ```r #
install.packages("devtools")
devtools::install_github("Prof-ThiagoOliveira/lcc") ``` If you use
